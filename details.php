...
<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top" id="navbar">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto text-uppercase">
			...
			<li>
				<a class="active" href="shop.php">Purchase</a>
			</li>
						  ...
						  <div class="card-body">
						    ...
						    ?>
								<form method="post">
								    ...
								    <label for="product_qty" class="col-sm-5 col-form-label-sm text-xl-right">Project Quantity :-</label>
								    <div class="col-sm-7">
								  ...
								  <div class="form-group row">
								    <label for="product_size" class="col-sm-5 col-form-label-sm text-xl-right"> Technology :- </label>
								    <div class="col-sm-7">
								  ...
								  <p class="btn btn-sm btn-info mb-0">Developers : <?php echo $manufacturer_title; ?></p>
