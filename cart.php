...
<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top" id="navbar">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto text-uppercase">
			...
			<li>
				<a class="active" href="cart.php">Project Cart</a>
			</li>
			<li>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9">
				<div class="card mb-3">
				  <div class="card-body">
				    <h5 class="card-title">Project Cart</h5>
				    <p class="card-text text-muted">You currently have <?php echo $getFromU->count_product_by_ip($ip_add); ?> Projects in Cart.</p>
							...
							<div class="card-footer">
								<div class="row">
									<div class="col-lg-3 pr-1 pb-2">
										<a href="index.php" class="btn btn-outline-primary form-control"><i class="fas fa-chevron-left"></i> Continue Purchase</a>
									</div>
									<div class="col-lg-2 pr-1 pb-2">
										<a href="details.php?product_id=<?php echo $product_id; ?>" class="btn btn-outline-secondary form-control"><i class="fas fa-book"></i> Details</a>
									</div>
									<div class="col-lg-3 pr-lg-3 pr-1 pb-2">
										<button class="btn btn-outline-danger float-sm-right form-control" type="submit" name="update" value="Update Cart">
							...
							if (isset($_POST['update']) && !empty($_POST['update'])) {
								if (!empty($_POST['remove'])) {
									...
									if ($delete_id) {
										...
										echo '<script>alert("Prroject(s) Deleted Sucessfully")</script>';
				  ...
				  <div class="card-body">
				    ...
				    <table class="table table-hover text-center">
						  ...
						  <tbody>
						    ...
						    <tr>
						      <th>Total</th>
						      <th class="text-right">$ <?php echo number_format($total + $tax, 2); ?></th>
						    </tr>
						  </tbody>
						</table>
				  </div>
		...
		<div class="row suggestion_heading">
			<div class="col-md-12 ">
				<div class="text-center">
					<h2 class="">You may also Like this Projects</h2>
				</div>
			</div>
		</div>
